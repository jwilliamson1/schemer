...
((t1 'print))
((t1 'insert-proc!) (list 12) 'cousin)
((t1 'insert-proc!) (list 12 5) 'cousina)
((t1 'insert-proc!) (list 12 3) 'pepe)
((t1 'insert-proc!) (list 13) 'evil-twin)
((t1 'insert-proc!) (list 6 6 6) 'bael)
((t1 'insert-proc!) (list 15 15 15) 'hydra)
((t1 'insert-proc!) (list 15 14 15) 'hydra)
((t1 'print))